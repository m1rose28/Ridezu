			<section id="precontent">
				...
				<div id="right3">
					<h3>Collect</h3>
					<a id="savings" class="glassbg" onclick="navt('ridepostp','commutep');">
			...
			<div id="r3" style="display:none;">
				...
				<section id="postcontent">
					<a onclick="nav('ridepostp','myridesp');"><div class="secondarybutton greyscale" id="left2"><p>View My Rides</p></div></a>
					<a onclick="newride();" id="show-confirmation"><div class="secondarybutton" id="right2"><p>Post Another Ride</p></div></a>
				</section>					
