...
@property (nonatomic, assign) BOOL forcePosition;
...
@synthesize centerPoint, forcePosition;
...
+ (void)forceCenter:(CGPoint)center {
    [SVProgressHUD sharedView].forcePosition = YES;
    [SVProgressHUD sharedView].centerPoint = center;
}
...
//    if (self.forcePosition) {
//        NSLog(@"force Positioning mode ...");
//        [self moveToPoint:self.centerPoint rotateAngle:0.0];
//        return;
//    }
