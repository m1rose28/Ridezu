...
- (void)viewDidLoad
{
    ...
    NSString *urlString = [NSString stringWithFormat:@"http://stage.ridezu.com/index1.php?client=iOS&fbid=%@&seckey=%@&p=congratp",[defaults valueForKey:@"fbid"],[defaults valueForKey:@"secretKey"]];
