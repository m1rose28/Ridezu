...
@interface LiveViewController : UIViewController<MKMapViewDelegate,UITextFieldDelegate,NSURLConnectionDelegate,CLLocationManagerDelegate,AZDraggableAnnotationViewDelegate,UIGestureRecognizerDelegate>
{
