...
- (UIBarButtonItem *)menuBarButtonItem {
    ...
    UIButton *toggleView = [[UIButton alloc] initWithFrame:CGRectMake(0, 0, 40, 30)];
    [toggleView addTarget:self action:@selector(toggleSideMenuPressed:) forControlEvents:UIControlEventTouchUpInside];
    [toggleView setBackgroundImage:[UIImage imageNamed:@"menu-icon.png"] forState:UIControlStateNormal];    
    return [[UIBarButtonItem alloc] initWithCustomView:toggleView];
}
